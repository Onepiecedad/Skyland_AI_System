...
*"Välkommen till Skyland. Jag förstår att du är intresserad av [det de klickat på]. Är det okej om jag ställer ett par korta frågor först, så kan vi ge dig ett bättre svar?"*
