...
(function () {
  const translations = {
    en: {
      ...
      svc4_d: "Reminders, replies and bookings handled automatically. Nothing falls through the cracks.",
    ...
    sv: {
      ...
      svc4_d: "Påminnelser, svar och bokningar sköts automatiskt. Inget faller mellan stolarna.",
