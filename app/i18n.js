...
(function () {
  const translations = {
    en: {
      ...
      transmit_btn: "SEND",
      kontakt_to_system: "Watch your case card build on The System →",
      ...
      svc3_t: "Gaps in the calendar",
      svc3_d: "Every empty hour costs you money. We keep the right customers coming — all the way to a booked meeting. More of your week becomes revenue.",
      svc4_t: "Enquiries that get forgotten",
      svc4_d: "Someone asked, and then it went quiet. Every enquiry is followed up until it has an answer — more of what you already have becomes business.",
      ...
      void_sub: "Tell us what's costing you time or money — too few customers, too much admin, enquiries that disappear. You get a first answer right away, and an honest assessment of what you'd gain by solving it.",
      ...
      dash_empty: "No case card yet. Try the voice agent or the form and watch the card build itself here — in real time.",
      ...
      dash_desc_short: "This is your session, live. Talk to Alex or use the form and watch it happen here in real time: enquiries, replies, bookings, ROI. The same system our clients use.",
      dash_tab_lead: "Your case",
      ...
      dash_kpi_2_v: "24/7",
      dash_kpi_2_l: "captures enquiries while you sleep",
      dash_kpi_3_v: "100%",
      dash_kpi_3_l: "logged — nothing gets forgotten",
      dash_kpi_4_v: "0",
      dash_kpi_4_l: "manual steps to a booked meeting",
      dash_overview_note: "The figures above describe how the system is built to work — not the results of this session. What happened in your session is under \"Your session\". The same engine answers our customers' phones, forms and bookings — every day.",
      ...
      dash_ag3_t: "Prioritising enquiries",
    ...
    sv: {
      ...
      transmit_btn: "SKICKA",
      kontakt_to_system: "Se ditt ärendekort byggas på Systemet →",
      ...
      svc3_t: "Luckor i kalendern",
      svc3_d: "Varje tom timme kostar dig pengar. Vi fyller på med rätt kunder — hela vägen till bokat möte. Mer av din vecka blir intäkt.",
      svc4_t: "Förfrågningar som glöms bort",
      svc4_d: "Någon hörde av sig, och sen blev det tyst. Varje förfrågan följs upp tills den har ett svar — mer av det du redan har blir affär.",
      ...
      void_sub: "Skriv vad som kostar dig tid eller pengar — för få kunder, för mycket admin, förfrågningar som försvinner. Du får ett första svar direkt och en ärlig bedömning av vad du kan vinna på att lösa det.",
      ...
      dash_empty: "Inget ärendekort än. Testa röstagenten eller formuläret och se kortet byggas här — i realtid.",
      ...
      dash_desc_short: "Det här är din session, live. Prata med Alex eller använd formuläret och se det hända här i realtid: förfrågningar, svar, bokningar, ROI. Samma system som våra kunder använder.",
      dash_tab_lead: "Ditt ärende",
      ...
      dash_kpi_2_v: "24/7",
      dash_kpi_2_l: "fångar förfrågningar medan du sover",
      dash_kpi_3_v: "100 %",
      dash_kpi_3_l: "loggat — inget glöms bort",
      dash_kpi_4_v: "0",
      dash_kpi_4_l: "manuella steg till bokat möte",
      dash_overview_note: "Siffrorna ovan beskriver hur systemet är byggt att jobba — inte resultatet av din session. Det som hände i din session ser du under \"Din session\". Samma motor svarar i våra kunders telefoner, formulär och bokningar — varje dag.",
      ...
      dash_ag3_t: "Prioritering av förfrågningar",
